...
<form class="form_about_us" action="${pageContext.request.contextPath}/controller?command=send" method="post">
    <input placeholder="<fmt:message key="label.nameMenu"/>" class="about_us_input" type="text" id="name" name="name"
           required minlength="4" pattern="^[a-zA-Z]+(([',. -][a-zA-Z ])?[a-zA-Z]*)*$"><br>
    ...
    <input class="apply-cart" type="submit" value="Submit">
</form>
</body>
</html>
